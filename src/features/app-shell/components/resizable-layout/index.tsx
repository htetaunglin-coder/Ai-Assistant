...
export type ResizableLayoutPanelState = {
  [id: string]: boolean
}
...
export type ResizableLayoutProviderProps = {
  initialState?: ResizableLayoutPanelState
  children: React.ReactNode
}

const ResizableLayoutProvider = ({ initialState = {}, children }: ResizableLayoutProviderProps) => {
  const [panels, setPanels] = useState<ResizableLayoutPanelState>(initialState)
...
export type ResizableLayoutGroupProps = React.ComponentProps<typeof ResizablePanelGroup> & {
  defaultLayout?: number[]
}

const ResizableLayoutGroup = ({ children, onLayout, defaultLayout, ...props }: ResizableLayoutGroupProps) => {
