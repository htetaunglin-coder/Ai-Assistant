...
const ConversationArea = () => {
  ...
  return (
    <AIConversation className="relative flex size-full overflow-hidden">
      ...
      <AIConversationScrollButton className="absolute bottom-[calc(var(--prompt-area-height)+5rem)] left-1/2 z-30 -translate-x-1/2 md:bottom-[calc(var(--prompt-area-height)+6rem)]" />
    </AIConversation>
  )
}
